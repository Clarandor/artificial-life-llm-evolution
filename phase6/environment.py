...
- REMOVE small prey entirely — coordination is the ONLY way to get food
- Large prey: needs 2 SAME-TRIBE agents attacking simultaneously
- Add coordination supervision loss: penalize failed coordinated attacks
- Reduce coordination difficulty: larger prey hitbox
"""
...
ATT_DIM = 4
MAX_NEIGHBORS = 8
OBS_DIM = 20  # 16 base + 4 coordination
