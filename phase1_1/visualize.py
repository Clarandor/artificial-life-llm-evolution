"""
Phase 1.1: Visualization — Factored Attention
=================================================
Same plots as Phase 1 but with updated titles.
"""
...
def plot_fitness_curve(generation_log: List[dict], save=True):
    ...
    fig.suptitle("Phase 1.1: Fitness (Factored Attention, ATT_DIM=4, no V)", fontsize=14, fontweight="bold")
...
def plot_prey_captures(generation_log: List[dict], save=True):
    ...
    fig, ax = plt.subplots(figsize=(10, 5))
    fig.suptitle("Phase 1.1: Cooperative Prey Captures (Factored Attention)", fontsize=14, fontweight="bold")
...
def plot_attention_entropy(generation_log: List[dict], save=True):
    ...
    fig, ax = plt.subplots(figsize=(10, 5))
    fig.suptitle("Phase 1.1: Attention Entropy (ATT_DIM=4, no V)", fontsize=14, fontweight="bold")
...
def plot_tribe_competition(generation_log: List[dict], save=True):
    ...
    fig.suptitle("Phase 1.1: Tribe Competition (Factored Attention)", fontsize=14, fontweight="bold")
...
def plot_hidden_pca(generation_log: List[dict], save=True):
    ...
    ax.set_title("PCA of Agent Hidden States — Factored Attention (32D → 2D)", fontsize=13)
