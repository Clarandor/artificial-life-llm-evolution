"""
Phase 1.1: Grid World — Factored Attention
============================================
Same as Phase 1 environment but imports from phase1_1.agent.
"""
...
class GridWorld:
    ...
    def _emergency_respawn(self):
        from .agent import FactoredAttentionMLP
        needed = MIN_AGENTS - len(self.agents)
        for _ in range(needed):
            mlp = FactoredAttentionMLP()
            agent = Agent(
                id=self._next_agent_id,
