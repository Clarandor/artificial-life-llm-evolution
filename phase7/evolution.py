"""
Phase 7: Evolution with Recursive Attention (Theory of Mind)
============================================================
Key innovation: agents receive neighbors' attention weights from the previous step,
enabling Level-2 (recursive) attention.

This means each agent can reason about "what is my neighbor attending to?"
...
from .agent import HIDDEN_DIM, ATT_DIM, GRID_SIZE, Agent, RecursiveAttention, LSTMCell
...
class Evolution:
    ...
    def __init__(self, seed=42):
        ...
        for t in range(self.N_TRIBES):
            ...
            self.tribe_templates[t] = {
                ...
                'attn': RecursiveAttention(HIDDEN_DIM, ATT_DIM, rng_t),
            }
        ...
        attn_p = 2 * ATT_DIM * HIDDEN_DIM + ATT_DIM * 8
        print(f"  RecursiveAttention: Level1 (Q/K) + Level2 (neighbor attn aggregation)")
    ...
    def run(self, generations=100, save_log=True):
        ...
        print(f"\nStarting Phase 7: Recursive Attention (Theory of Mind)")
        ...
        for gen in range(generations):
                ...
                for agent in alive:
                    ...
                    if nh_h:
                        ...
                        if len(aw) > 1:
                            ...
                            # Reward low entropy (target: peaked distribution = coordinated attention)
            ...
            if gen % 10 == 0:
                ...
                print(f"Gen {gen:4d} | pop={len(alive):3d} | "
                      ...
                      f"Rec={rec_usage:.3f} | ⏱ {elapsed:.0f}s",
                      flush=True)
        ...
        if save_log:
            ...
            with open("results/phase7/generation_log.json", "w") as f:
